...
def getHtml(url):
    ...
    print user_agent
    html = urllib2.urlopen(request,timeout=3).read()
    return proxy_ip
urls = ['http://zt.luoohu.com/api/Index160428/Vote?callback=jQuery111107297161973923512_1463899034117&PId=38&DataCategory=1&_=1463899034140']
    ...
    for url in urls:
        ...
        try:
            ...
            count_False += 1
             ...
             count_False += 1
        randomTime = random.uniform(1,1) #取1-10之间的随机浮点数
        time.sleep(randomTime) #随机等待时间
        print u'%d Eroors,%d ok,总数 %d' %(count_False,count - count_False,count)
